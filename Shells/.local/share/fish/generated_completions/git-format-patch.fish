...
complete -c git-format-patch -l indent-heuristic --description 'Enable the heuristic that shift diff hunk boundaries to make patches easier t…'
...
complete -c git-format-patch -l ignore-cr-at-eol --description 'Ignore carrige-return at the end of line when doing a comparison.'
