...
complete -c mmcli -l location-enable-agps --description 'Enable A-GPS (MSA) support.'
complete -c mmcli -l location-enable-gps-nmea --description '.'
complete -c mmcli -l location-disable-agps --description 'Disable A-GPS (MSA) support.'
