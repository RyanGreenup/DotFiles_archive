...
complete -c rgrep -s i -l ignore-case --description 'Ignore case distinctions, so that characters that differ only in case match e…'
...
complete -c rgrep -s z --description 'option is not given.'
