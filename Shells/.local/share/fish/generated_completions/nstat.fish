...
complete -c nstat -s z -l zero --description 'Dump zero counters too.  By default they are not shown.'
...
complete -c nstat -s d -l interval --description 'Run in daemon mode collecting statistics.'
