...
complete -c git-config -l path --description 'git config will expand a leading ~ to the value of $HOME, and ~user to the ho…'
complete -c git-config -l expiry-date --description 'git config will ensure that the output is converted from a fixed or relative …'
