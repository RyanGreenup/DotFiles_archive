...
complete -c git-diff-index -l indent-heuristic --description 'Enable the heuristic that shift diff hunk boundaries to make patches easier t…'
...
complete -c git-diff-index -l ignore-cr-at-eol --description 'Ignore carrige-return at the end of line when doing a comparison.'
