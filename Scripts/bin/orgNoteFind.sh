...
# sk --ansi -m -c 'rg -l -t org -t markdown --ignore-case "{}"'    \
#    --preview "cat {} | bat --italic-text always -f -P --wrap never --theme \"Sublime Snazzy\" -l org |\
sk --ansi -m -c 'rg -l -t org --ignore-case "{}"'    \
    --preview "bat --style=plain {}  --italic-text always -f -P --wrap never --theme \"Sublime Snazzy\" -l org |\
